(function(global2, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("lodash-unified"), require("axios"), require("file-saver"), require("html-docx-js-typescript"), require("exceljs")) : typeof define === "function" && define.amd ? define(["exports", "lodash-unified", "axios", "file-saver", "html-docx-js-typescript", "exceljs"], factory) : (global2 = typeof globalThis !== "undefined" ? globalThis : global2 || self, factory(global2.zhdgpsUtils = {}, global2.lodashUnified, global2.axios, global2.fileSaver, global2.htmlDocxJsTypescript, global2.ExcelJS));
})(this, function(exports2, lodashUnified, axios, fileSaver, htmlDocxJsTypescript, ExcelJS) {
  "use strict";
...
Component that was made reactive: `,
  ...
  function isEpProp(val) {
    return isObject(val) && !!val[epPropKey];
  }
  function buildProp(prop, key) {
    ...
    const temp = values || validator ? (val) => {
      let valid = false;
      let allowedValues = [];
      if (values) {
  ...
  async function GetWeather(adcode, extensions = "base", key = "") {
    const res = await axios({
  ...
  async function GetGeocode(address, key = "") {
    const res = await axios({
  ...
  async function GetReGeocode(location, key = "") {
    const res = await axios({
  ...
  const amap = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
    __proto__: null,
    GetGeocode,
    GetIPLocation,
    GetReGeocode,
  ...
  function bd09togcj02(bd_lon, bd_lat) {
    const X_PI2 = 3.141592653589793 * 3e3 / 180;
    const x = bd_lon - 65e-4;
    const y = bd_lat - 6e-3;
    const z = Math.sqrt(x * x + y * y) - 2e-5 * Math.sin(y * X_PI2);
    const theta = Math.atan2(y, x) - 3e-6 * Math.cos(x * X_PI2);
  ...
  `;
    await sleep(300);
    htmlDocxJsTypescript.asBlob(content, { orientation, margins }).then((data) => {
  ...
  function getClassAndStylesFromNode(node) {
    if (node) {
  ...
  function convertImagesToDataUrl(cloneElement, sourceElement) {
    ...
    sourceImages.forEach((imgElement, index2) => {
      ...
      try {
        ctx == null ? void 0 : ctx.drawImage(imgElement, 0, 0, width, height);
        const dataURL = canvas.toDataURL(IMAGE_TYPE, IMAGE_QUALITY);
        const replaceElement = cloneImages[index2];
  ...
  function convertCanvasToDataUrl(cloneElement, sourceElement) {
    ...
    sourceCanvas.forEach((canvasElement, index2) => {
      const dataURL = canvasElement.toDataURL(IMAGE_TYPE, IMAGE_QUALITY);
      const imgElement = document.createElement("img");
      imgElement.src = dataURL;
      const replaceElement = cloneCanvas[index2];
  ...
  function ExportJsonToExcel(params) {
    let {
      columns,
      data,
      filename,
  ...
  function ExportTableToExcel({ table, filename, style }) {
      ...
      if (item.$dataValidation) {
        column.eachCell((cell, rowNumber) => {
          if (rowNumber !== 1) {
            ...
            if (longLen) {
              const newCol = newSheet.getColumn(index2);
              newCol.values = formulae.split(",");
              const col = newCol.letter;
              const { rowCount } = newCol._worksheet;
              cell.dataValidation = { ...rest, formulae: [`Sheet2!$${col}$1:$${col}$${rowCount}`] };
            } else {
  ...
  async function readExcelToJson(buffer) {
    let columns = [];
    const data = [];
    const workbook = new ExcelJS.Workbook();
      ...
      worksheet.eachRow((row, rowNumber) => {
        ...
        if (Array.isArray(rowValues)) {
          ...
          if (rowNumber === 1) {
            ...
            const sheetToJson = {};
            rowValues.forEach((item, index2) => {
              sheetToJson[columns[index2]] = item;
            });
  ...
  const excel = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
    __proto__: null,
    ExportJsonToExcel,
    ExportTableToExcel,
    readExcelToJson
  ...
  exports2.cancelAnimationFrame = cancelAnimationFrame;
  exports2.definePropType = definePropType;
  exports2.doc = doc;
  exports2.epPropKey = epPropKey;
  exports2.excel = excel;
  exports2.gis = index;
  exports2.isEpProp = isEpProp;
  exports2.requestAnimationFrame = requestAnimationFrame;
